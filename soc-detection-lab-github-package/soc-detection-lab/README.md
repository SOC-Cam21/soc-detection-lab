...
> Built a local SOC detection lab using Splunk Enterprise, Sysmon, and the Splunk Universal Forwarder to collect Windows endpoint telemetry, troubleshoot SIEM ingestion issues, and perform basic threat hunting using SPL.
